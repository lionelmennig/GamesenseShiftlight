...
class RedEventUtils(BaseEventUtils):
    ...
    def canIgnoreUpdatingCurrentValue():
        return (__lastConvertedValues[0] == 0 and __lastConvertedValues[1] == 0 and __lastConvertedValues[2] == 0)
            or (__lastConvertedValues[0] > 0 and __lastConvertedValues[0] <= 50 and __lastConvertedValues[1] > 0 and __lastConvertedValues[1] <= 50 and __lastConvertedValues[2] > 0 and __lastConvertedValues[2] <= 50)
